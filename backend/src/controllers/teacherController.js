...
exports.createSession = async (req, res) => {
  try {
    const { title, scheduledStart, durationMinutes, mcqBankId, division, courseId, board, subject: subjectFromBody, requireCamera, enableAIProctoring, lockBrowser, maxViolations } =
      req.body;
...
exports.updateSession = async (req, res) => {
  try {
    const { title, durationMinutes, division, board, scheduledStart, requireCamera, enableAIProctoring, lockBrowser, maxViolations } = req.body;
    const updateData = { title, duration: durationMinutes, division, requireCamera, enableAIProctoring, lockBrowser, maxViolations };
...
exports.createStudent = async (req, res) => {
  try {
    const { name, email, password, courseId, classTag, board } = req.body;
...
exports.updateStudent = async (req, res) => {
  try {
    const { id } = req.params;
    const { name, email, courseId, classTag, board } = req.body;
